...
RUN apt-get update -y && \
    ...
    apt-get update -y && \
    apt-get install -y tigervnc-standalone-server openbox gstreamer1.0-plugins-good pulseaudio avahi-daemon netcat-openbsd xdotool spotify-client firefox-esr && \
